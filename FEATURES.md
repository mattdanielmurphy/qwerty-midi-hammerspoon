...
- **Built-in Arpeggiator**: Integrated arpeggiator engine with multiple modes (UP, DOWN, UP-DOWN, RANDOM), selectable BPM speeds (freeform text input, arrow adjustments), per-row ARP filters, and real-time visual key highlights on active arpeggiated notes.
